	...
	items := []*cartDomain.Item{
		{
			...
			SourceID:                             "warehouse1",
			Qty:                                  5,
			SinglePriceGross:                     priceDomain.NewFromInt(2065, 100, "EUR"),
			SinglePriceNet:                       priceDomain.NewFromInt(1930, 100, "EUR"),
			RowPriceGross:                        priceDomain.NewFromInt(2065*5, 100, "EUR"),
			RowPriceGrossWithDiscount:            priceDomain.NewFromInt(2065*5-3172, 100, "EUR"),
			RowPriceGrossWithItemRelatedDiscount: priceDomain.NewFromInt(2065*5, 100, "EUR"),
			RowPriceNet:                          priceDomain.NewFromInt(1930*5, 100, "EUR"),
			RowPriceNetWithDiscount:              priceDomain.NewFromInt(6685, 100, "EUR"),
			RowPriceNetWithItemRelatedDiscount:   priceDomain.NewFromInt(1930*5, 100, "EUR"),
			RowTaxes:                             []cartDomain.Tax{{Amount: priceDomain.NewFromInt(468, 100, "EUR"), Type: "tax", Rate: big.NewFloat(7)}},
			AppliedDiscounts: cartDomain.AppliedDiscounts{
				cartDomain.AppliedDiscount{IsItemRelated: true, Applied: priceDomain.NewFromInt(-3172, 100, "EUR")},
			},
			TotalDiscountAmount:          priceDomain.NewFromInt(-3172, 100, "EUR"),
			ItemRelatedDiscountAmount:    priceDomain.NewFromInt(-3172, 100, "EUR"),
			NonItemRelatedDiscountAmount: priceDomain.NewFromInt(0, 100, "EUR"),
		...
		},
		{
			...
			RowTaxes:                             []cartDomain.Tax{{Amount: priceDomain.NewFromInt(468, 100, "EUR"), Type: "tax", Rate: big.NewFloat(7)}},
			AppliedDiscounts: cartDomain.AppliedDiscounts{
				cartDomain.AppliedDiscount{IsItemRelated: false, Applied: priceDomain.NewFromInt(-3172, 100, "EUR")},
			},
			TotalDiscountAmount:          priceDomain.NewFromInt(-3172, 100, "EUR"),
			ItemRelatedDiscountAmount:    priceDomain.NewFromInt(0, 100, "EUR"),
			NonItemRelatedDiscountAmount: priceDomain.NewFromInt(-3172, 100, "EUR"),
