...
type mockConstructorTestingTNewProductSearchService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewProductSearchService(t mockConstructorTestingTNewProductSearchService) *ProductSearchService {
