...
type mockConstructorTestingTNewWebCartPaymentGateway interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewWebCartPaymentGateway(t mockConstructorTestingTNewWebCartPaymentGateway) *WebCartPaymentGateway {
