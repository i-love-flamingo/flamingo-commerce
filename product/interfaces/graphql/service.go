...
func (*Service) Types(types *graphql.Types) {
	...
	types.Map("Commerce_Product_Specifications", graphqlProductDto.ProductSpecifications{})
	types.Map("Commerce_Product_SpecificationGroup", graphqlProductDto.ProductSpecificationGroup{})
	types.Map("Commerce_Product_SpecificationEntry", graphqlProductDto.ProductSpecificationEntry{})
