...
func (*Service) Models() map[string]config.TypeMapEntry {
	return graphql.ModelMap{
		...
		"Commerce_Cart_Taxes":                   cart.Taxes{},
		...
		"Commerce_Cart_PricedItems":             cart.PricedItems{},
		"Commerce_Cart_PricedCartItem":          cart.PricedCartItem{},
		"Commerce_Cart_PricedShippingItem":      cart.PricedShippingItem{},
		"Commerce_Cart_PricedTotalItem":         cart.PricedTotalItem{},
