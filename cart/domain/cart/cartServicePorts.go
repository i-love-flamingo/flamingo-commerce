...
//go:generate go run github.com/vektra/mockery/v2@v3.2.5 --name CompleteBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.2.5 --name CustomerCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.2.5 --name GiftCardAndVoucherBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.2.5 --name GiftCardBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.2.5 --name GuestCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.2.5 --name ModifyBehaviour --case snake
