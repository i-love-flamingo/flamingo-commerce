...
func schemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema.graphql", size: 4232, mode: os.FileMode(420), modTime: time.Unix(1567424712, 0)}
