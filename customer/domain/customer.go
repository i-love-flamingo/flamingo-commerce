...
//go:generate go run github.com/vektra/mockery/v2@v3.3.2 --name Customer --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.3.2 --name CustomerIdentityService --case snake
