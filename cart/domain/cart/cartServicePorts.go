...
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name CompleteBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name CustomerCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name GiftCardAndVoucherBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name GiftCardBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name GuestCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name ModifyBehaviour --case snake
