...
func (*Service) Types(types *graphql.Types) {
	...
	types.Map("Commerce_Product_VariantSelectionAttribute", graphqlProductDto.VariantSelectionAttribute{})
	types.Map("Commerce_Product_VariantSelectionAttributeOption", graphqlProductDto.VariantSelectionAttributeOption{})
	types.Map("Commerce_Product_OtherAttributesRestriction", graphqlProductDto.OtherAttributesRestriction{})
	types.Map("Commerce_Product_VariantSelectionVariant", graphqlProductDto.VariantSelectionVariant{})
	types.Map("Commerce_Product_MatchingVariantSelection", graphqlProductDto.MatchingVariantSelection{})
	types.Map("Commerce_Product_VariantSelectionVariantMatchingVariant", graphqlProductDto.VariantSelectionVariantMatchingVariant{})
