...
//go:generate go run github.com/vektra/mockery/v2@v2.45.0 --name GiftCardHandler --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.45.0 --name VoucherHandler --case snake
