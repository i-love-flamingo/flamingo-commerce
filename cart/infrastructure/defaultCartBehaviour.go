...
//go:generate go run github.com/vektra/mockery/v2@v2.53.3 --name GiftCardHandler --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.53.3 --name VoucherHandler --case snake
