...
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name GiftCardHandler --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.46.2 --name VoucherHandler --case snake
