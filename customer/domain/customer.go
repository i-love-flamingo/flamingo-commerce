...
//go:generate go run github.com/vektra/mockery/v2@v2.44.1 --name Customer --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.44.1 --name CustomerIdentityService --case snake
