...
//go:generate go run github.com/vektra/mockery/v2@v3.3.3 --name GiftCardHandler --case snake
//go:generate go run github.com/vektra/mockery/v2@v3.3.3 --name VoucherHandler --case snake
