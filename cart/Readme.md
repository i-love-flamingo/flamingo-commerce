...
| SubTotalGrossWithDiscounts()      |                                                                              | SubTotalGross() + SumSubTotalDiscountAmount()                          |
...
| Key                               | Desc                                                                                                           | Math                                                                                      |
|-----------------------------------|----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| GrandTotal()                      | The final amount that need to be paid by the customer (Gross)                                                  | Sum(RowPriceGrossWithDiscount) + Sum(shipping.PriceGrossWithDiscounts) + Sum(Totalitems) |
