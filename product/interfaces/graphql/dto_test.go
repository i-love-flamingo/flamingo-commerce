...
func TestSearchResultDTO_BuiltInFacetTypes(t *testing.T) {
	t.Parallel()
...
func TestSearchResultDTO_CustomMapper(t *testing.T) {
	t.Parallel()
...
func TestSearchResultDTO_MapperPriority(t *testing.T) {
	t.Parallel()
...
func TestSearchResultDTO_FacetsWithoutMappers(t *testing.T) {
	t.Parallel()
