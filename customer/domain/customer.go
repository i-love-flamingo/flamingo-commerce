...
//go:generate go run github.com/vektra/mockery/v2@v2.42.2 --name Customer --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.2 --name CustomerIdentityService --case snake
