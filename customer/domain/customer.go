...
//go:generate go run github.com/vektra/mockery/v2@v2.52.3 --name Customer --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.52.3 --name CustomerIdentityService --case snake
