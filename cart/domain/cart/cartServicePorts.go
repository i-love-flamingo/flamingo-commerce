...
//go:generate go run github.com/vektra/mockery/v2@v2.53.6 --name CompleteBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.53.6 --name CustomerCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.53.6 --name GiftCardAndVoucherBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.53.6 --name GiftCardBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.53.6 --name GuestCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.53.6 --name ModifyBehaviour --case snake
