...
s/\.SumSubTotalDiscountAmount()/.SubTotalDiscountAmount/
...
# cart
s/\.GrandTotal()/.GrandTotal/
s/\.SumShippingNet()/.ShippingNet/
s/\.SumShippingNetWithDiscounts()/.ShippingNetWithDiscounts/
s/\.SumShippingGross()/.ShippingGross/
s/\.SumShippingGrossWithDiscounts()/.ShippingGrossWithDiscounts/
s/\.SubTotalGross()/.SubTotalGross/
s/\.SubTotalNet()/.SubTotalNet/
s/\.SubTotalGrossWithDiscounts()/.SubTotalGrossWithDiscounts/
s/\.SubTotalNetWithDiscounts()/.SubTotalNetWithDiscounts/
